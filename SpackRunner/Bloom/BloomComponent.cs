...
namespace BloomPostprocess
{
	...
	public class BloomComponent : DrawableGameComponent
	{
		...
		protected override void LoadContent ()
		{
			...
			bloomExtractEffect = Game.Content.Load<Effect> ("Models\\BloomExtract");
			bloomCombineEffect = Game.Content.Load<Effect> ("Models\\BloomCombine");
			gaussianBlurEffect = Game.Content.Load<Effect> ("Models\\GaussianBlur");
