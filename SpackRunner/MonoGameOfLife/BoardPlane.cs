...
namespace SpackRunner
{
	public class BoardPlane
	{
		...
		public BoardPlane ()
		{
			boundingBox = new BoundingBox (new Vector3 (-500, -1, -500), new Vector3 (500, 1, 500));
		}

		public void Draw (GraphicsDevice graphicsDevice, ArcBallCamera cam, VertexPositionColor[] pvc)
		{
			...
			var buffers = CreateBoundingBoxBuffers (boundingBox, graphicsDevice);
			...
			graphicsDevice.DrawUserPrimitives (PrimitiveType.LineList, pvc, 0, 1);
		}
